...
class Car:
    def __init__(self, name: str, price: int, fuel_economy: float, service_cost: int, insurance_cost: int):
        ...
        self.fuel_economy = fuel_economy  # l/100 km    # расход_топлива
        self.service_cost = service_cost                # стоимость_обслуживания
        self.insurance_cost = insurance_cost            # стоимость_страховки
